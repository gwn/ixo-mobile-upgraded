...
export default {
  ...
  // Tab
  tabDefaultBg:
    platform === 'ios' ? ThemeColors.blue_dark : ThemeColors.blue_dark,
  topTabBarTextColor:
    platform === 'ios' ? ThemeColors.white : ThemeColors.white,
  topTabBarActiveTextColor:
    platform === 'ios' ? ThemeColors.white : ThemeColors.white,
  topTabBarBorderColor: platform === 'ios' ? '#fff' : '#fff',
  topTabBarActiveBorderColor:
    platform === 'ios' ? ThemeColors.blue_lightest : ThemeColors.blue_lightest,
